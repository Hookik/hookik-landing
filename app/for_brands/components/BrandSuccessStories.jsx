import { brandSuccess } from "@/constants/forBrands";
      ...
      <div className="flex flex-col gap-y-10 my-16 container mx-auto max-w-[1400px] px-4 items-center">
        <div className="flex flex-col gap-y-4">
          ...
          <p className="text-[#4B5563] text-center">
            See how other brands achieved success with creator partnerships
          </p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {brandSuccess?.map((item) => (
            <div
              key={item?.id}
            ...
            >
              ...
              <div className="flex flex-col gap-y-4 mt-3 px-4">
                ...
                <p className="text-[#4B5563] text-sm leading-6 font-medium first:text-[#8937CE]">
                  {item?.stat}
                </p>
...
export default BrandSuccessStories;
