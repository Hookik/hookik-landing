        ...
        <div className="flex flex-col gap-y-10 my-16 container mx-auto max-w-[1400px] px-4 items-center">
          <div className="flex flex-col gap-y-4">
            <h2 className="font-bold text-3xl text-[#00002E] text-center">
              Why Creators Love hookik
            </h2>
            <p className="text-[#4B5563] text-center">
              We support creators at every stage with the tools and connections
              you need
            </p>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {whyCreatorsloveHookik?.map((item) => (
              <div
                key={item?.id}
...
export default WhyCreatorsLoveHookik;
