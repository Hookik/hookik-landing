...
import { whyShopThroughHookik } from "@/constants/forShoppers";
import React from "react";

const WhyShopThroughHookikSection = () => {
  return (
    <>
      <div className="flex flex-col gap-y-10 my-16 container mx-auto max-w-[1400px] px-4 items-center">
        <div className="flex flex-col gap-y-4">
          <h2 className="font-bold text-3xl text-[#00002E] text-center">
            Why Shop Through hookik
          </h2>
          <p className="text-[#4B5563] text-center">
            A better way to discover products that truly match your needs and
            style
          </p>
        </div>

        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
          {whyShopThroughHookik?.map((item) => (
            <div
              key={item?.id}
...
export default WhyShopThroughHookikSection;
